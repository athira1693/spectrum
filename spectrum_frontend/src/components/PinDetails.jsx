...
const PinDetails = ({ user }) => {
  ...
  return (
    <>
      <div
        className='flex xl:flex-row flex-col m-auto bg-light'
      ...
      >
        ...
        <div className='w-full p-5 flex-1 xl:w-620'>
          ...
          <div className='flex flex-wrap mt-6 gap-3'>
            ...
            <input
              ...
              className='flex-1 borer-gray-100 outline-none border-2 p-2 rounded-2xl focus:border-gray-300'
            />
            <button
              type='button'
              className='bg-red-500 text-white rounded-full px-6 p-y-2 font-semibold text-base outline-none'
              onClick={addComment}
            >
